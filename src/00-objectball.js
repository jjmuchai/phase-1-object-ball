...
// Call the function and log the output to check the object structure
...
// Call the function and log the output to check
console.log(homeTeamName());

// Function to return the points scored by a given player
...
// Call the functions and log the outputs to check
console.log(homeTeamName());
